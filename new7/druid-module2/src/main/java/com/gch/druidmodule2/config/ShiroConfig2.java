 ...
 * @date 2021/2/1-9:24
 */
import com.gch.druidmodule2.shiro.AccountRealm2;
import com.gch.druidmodule2.shiro.JwtFilter2;
...
public class ShiroConfig2 {
    ...
    @Bean
    public DefaultWebSecurityManager securityManager(AccountRealm2 accountRealm,
